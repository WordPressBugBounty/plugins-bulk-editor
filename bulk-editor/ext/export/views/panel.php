...
<div class="notice notice-warning">
    <p>
		...
		printf(
			...
			esc_html__('Export will be applied to: %s', 'bulk-editor'), '<span class="wpbe_action_will_be_applied_to">' . sprintf(esc_html__('all the [%s] on the site', 'bulk-editor'), esc_html($WPBE->settings->current_post_type)) . '</span>')
		?>
    </p>
</div>
...
<div class="col-lg-6">
	...
	<a href="javascript: wpbe_export_to_xml();void(0);" class="button button-primary button-large wpbe_export_posts_btn"><?php esc_html_e('Export to XML', 'bulk-editor') ?></a>
    ...
    <a href="<?php echo esc_url($download_link) ?>" target="_blank" class="button button-primary button-large wpbe_export_posts_btn_down" style="display: none;"><span class="icon-download"></span>&nbsp;<?php esc_html_e('download', 'bulk-editor') ?>&nbsp;<span class="icon-download"></span></a>
    <a href="<?php echo esc_url($download_link_xml) ?>" target="_blank" class="button button-primary button-large wpbe_export_posts_btn_down_xml" style="display: none; color: greenyellow;"><span class="icon-download"></span>&nbsp;<?php esc_html_e('download XML', 'bulk-editor') ?>&nbsp;<span class="icon-download"></span></a>
...
<ul>
    <li>
        <select id="wpbe_export_delimiter">
            ...
            <option value="^">^</option>
            <option value="~">~</option>
        </select>&nbsp;<?php WPBE_HELPER::draw_tooltip(esc_html__('Select CSV data delimiter.', 'bulk-editor')) ?>
    </li>
</ul>
