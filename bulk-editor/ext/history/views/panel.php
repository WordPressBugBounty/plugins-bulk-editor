    ...
    <div class="col-lg-12 wpbe_history_filters">
        ...
        <div class="col-lg-2" >
			...
			echo wp_kses(WPBE_HELPER::draw_select(array(
				...
				'select' => array('id' => true, 'class' => true, 'name' => true, 'data-field' => true, 'data-post-id' => true, 'onchange' => true, 'multiple' => true),
...
<input type="hidden"  id="wpbe_history_panel_nonce" value="<?php echo esc_attr(wp_create_nonce('wpbe_history_nonce')); ?>"  />
