...
function wpbe_meta_print_li($m) {
    ...
    <li class="wpbe_options_li">
        ...
        <div class="col-lg-4">
            <input type="text" name="wpbe_meta_fields[<?php echo esc_attr($m['meta_key']) ?>][title]" placeholder="<?php esc_html_e('enter title', 'bulk-editor') ?>" value="<?php echo esc_html($m['title']) ?>" class="wpbe_column_li_option wpbe_column_li_option2" />&nbsp;
